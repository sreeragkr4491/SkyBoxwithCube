//Perfect output(skybox with cube)
...
int main()
{
   ...
   // GLuint cubeTexture = TextureLoading::LoadTexture( "res/images/container1.jpg" );
    ...
    faces.push_back("res/images/skybox4/right.png");
    faces.push_back("res/images/skybox4/left.png");
    faces.push_back("res/images/skybox4/top.png");
    faces.push_back("res/images/skybox4/bottom.png");
    faces.push_back("res/images/skybox4/back.png");
    faces.push_back("res/images/skybox4/front.png");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glUniformMatrix4fv(viewlocation, 1, GL_FALSE, glm::value_ptr(view1));
